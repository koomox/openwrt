...
# sed -i "set network.\$1.dns='127.0.0.1 119.29.29.29 1.1.1.1'" openwrt/package/base-files/files/bin/config_generate
# sed -i "set network.\$1.gateway='192.168.0.1'" openwrt/package/base-files/files/bin/config_generate
